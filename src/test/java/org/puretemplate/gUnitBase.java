...
public class gUnitBase
{
    ...
    public Object execParser(String ruleName, String input, int scriptLine) throws ReflectiveOperationException
    {
        ANTLRStringStream is = new ANTLRStringStream(input);
        Class<? extends TokenSource> lexerClass = Class.forName(lexerClassName)
            .asSubclass(TokenSource.class);
        ...
        Class<? extends Parser> parserClass = Class.forName(parserClassName)
        ...
        if (adaptorClassName != null)
        {
            ...
            Class<? extends TreeAdaptor> adaptorClass = Class.forName(adaptorClassName)
                .asSubclass(TreeAdaptor.class);
