...
public class TestDictionaries extends BaseTest
{
    ...
    @Test
    public void testDictValuesAreTemplates() throws Exception
    {
    ...
    @Test
    public void testDictKeyLookupAsNonToStringableObject() throws Exception
    {
        // Make sure we try rendering stuff to string if not found as regular object
    ...
    @Test
    public void testDictMissingDefaultValueIsEmpty() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", \"float\":\"0.0\"] " +
            newline +
            "var(type,w,name) ::= \"<type> <name> = <typeInit.(type)>;\"" +
    ...
    @Test
    public void testDictMissingDefaultValueIsEmptyForNullKey() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", \"float\":\"0.0\"] " +
            newline +
            "var(type,w,name) ::= \"<type> <name> = <typeInit.(type)>;\"" +
    ...
    @Test
    public void testDictHiddenByFormalArg() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", \"float\":\"0.0\"] " +
            newline +
    ...
    @Test
    public void testDictEmptyValueAndAngleBracketStrings() throws Exception
    {
    ...
    @Test
    public void testDictDefaultValue() throws Exception
    {
    ...
    @Test
    public void testDictNullKeyGetsDefaultValue() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", default:\"null\"] " +
            newline +
            "var(type,name) ::= \"<type> <name> = <typeInit.(type)>;\"" +
    ...
    @Test
    public void testDictEmptyDefaultValue() throws Exception
    {
    ...
    @Test
    public void testDictDefaultValueIsKey() throws Exception
    {
     ...
     */
    @Test
    public void testDictDefaultStringAsKey() throws Exception
    {
     ...
     */
    @Test
    public void testDictDefaultIsDefaultString() throws Exception
    {
    ...
    @Test
    public void testDictViaEnclosingTemplates() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", \"float\":\"0.0\"] " +
            newline +
    ...
    @Test
    public void testDictViaEnclosingTemplates2() throws Exception
    {
        String templates = "typeInit ::= [\"int\":\"0\", \"float\":\"0.0\"] " +
            newline +
    ...
    @Test
    public void testImportDictionary() throws Exception
    {
        String Root = "d ::= [\"a\":\"b\"]\n";
    ...
    @Test
    public void testStringsInDictionary() throws Exception
    {
        ...
        String expecting = "  electric <field>" + newline + "  <field> force" + newline + "  in <field> between";
        Assert.assertEquals(expecting, st.render());
    }

    @Test
    public void testTemplatesInDictionary() throws Exception
    {
        String templates = "auxMap ::= [\n" +
            "   \"E\": {electric <field>},\n" +
            "   \"I\": {in <field> between},\n" +
        ...
        ST st = group.getInstanceOf("top");
        Assert.assertNotNull(st);
        String expecting = "  electric foo" + newline + "  foo force" + newline + "  in foo between";
        Assert.assertEquals(expecting, st.render());
    }
