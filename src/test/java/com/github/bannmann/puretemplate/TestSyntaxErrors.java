...
public class TestSyntaxErrors extends BaseTest
{
    ...
    @Test
    public void testUnterminatedExpr() throws Exception
    {
    ...
    @Test
    public void testValidButOutOfPlaceChar() throws Exception
    {
    ...
    @Test
    public void testValidButOutOfPlaceCharOnDifferentLine() throws Exception
    {
    ...
    @Test
    public void testErrorInNestedTemplate() throws Exception
    {
    ...
    @Test
    public void testEOFInExpr() throws Exception
    {
    ...
    @Test
    public void testEOFInExpr2() throws Exception
    {
    ...
    @Test
    public void testEOFInString() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "t.stg 1:20: EOF in string" + newline + "t.stg 1:20: premature EOF" + newline;
        String result = errors.toString();
        assertEquals(expected, result);
    }

    @Test
    public void testNonterminatedComment() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "t.stg 1:20: Nonterminated comment starting at 1:1: '!>' missing" + newline;
        String result = errors.toString();
        assertEquals(expected, result);
    }

    @Test
    public void testMissingRPAREN() throws Exception
    {
    ...
    @Test
    public void testRotPar() throws Exception
    {
