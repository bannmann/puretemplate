...
{
    @Test
    public void testEmbeddedRegion() throws Exception
    {
    ...
    @Test
    public void testDefineRegionInSubgroupOneInSubdir() throws Exception
    {
        String dir = getRandomDir();
        writeFile(dir, "g1.stg", "a() ::= <<[<@r()>]>>\n");
    ...
    @Test
    public void testDefineRegionInSubgroupBothInSubdir() throws Exception
    {
        String dir = getRandomDir();
    ...
    @Test
    public void testDefineRegionInSubgroupThatRefsSuper() throws Exception
    {
        String dir = getRandomDir();
    ...
    @Test
    public void testDefineRegionInSubgroup2() throws Exception
    {
        String dir = getRandomDir();
        String g1 = "a() ::= <<[<@r()>]>>\n";
        writeFile(dir, "g1.stg", g1);
    ...
    @Test
    public void testDefineRegionInSameGroup() throws Exception
    {
        String dir = getRandomDir();
        String g = "a() ::= <<[<@r()>]>>\n" + "@a.r() ::= <<foo>>\n";
    ...
    @Test
    public void testAnonymousTemplateInRegion() throws Exception
    {
        String dir = getRandomDir();
        String g = "a() ::= <<[<@r()>]>>\n" + "@a.r() ::= <<\n" + "<[\"foo\"]:{x|<x>}>\n" + ">>\n";
        writeFile(dir, "g.stg", g);
    ...
    @Test
    public void testAnonymousTemplateInRegionInSubdir() throws Exception
    {
    ...
    @Test
    public void testCantDefineEmbeddedRegionAgain() throws Exception
    {
        String dir = getRandomDir();
    ...
    @Test
    public void testCantDefineEmbeddedRegionAgainInTemplate() throws Exception
    {
        String dir = getRandomDir();
        String g = "a() ::= <<\n" + "[\n" + "<@r>foo<@end>\n" + "<@r()>" + "]\n" + ">>\n"; // error; dup
        writeFile(dir, "g.stg", g);
    ...
    @Test
    public void testMissingRegionName() throws Exception
    {
        String dir = getRandomDir();
        String g = "@t.() ::= \"\"\n";
        writeFile(dir, "g.stg", g);
    ...
    @Test
    public void testIndentBeforeRegionIsIgnored() throws Exception
    {
        String dir = getRandomDir();
        String g = "a() ::= <<[\n" + "  <@r>\n" + "  foo\n" + "  <@end>\n" + "]>>\n";
        writeFile(dir, "g.stg", g);
    ...
    @Test
    public void testRegionOverrideStripsNewlines() throws Exception
    {
        String dir = getRandomDir();
    ...
    @Test
    public void testRegionOverrideRefSuperRegion2Levels() throws Exception
    {
        String g = "a() ::= \"X<@r()>Y\"\n" + "@a.r() ::= \"foo\"\n";
    ...
    @Test
    public void testSuperRegionRefMissingOk() throws Exception
    {
        String dir = getRandomDir();
        String g = "a() ::= \"X<@r()>Y\"" + "@a.r() ::= \"foo\"" + newline;
        writeFile(dir, "g.stg", g);
    ...
    @Test
    public void testEmbeddedRegionOnOneLine() throws Exception
    {
        String dir = getRandomDir();
        String groupFile = "a() ::= <<\n" + "[\n" + "  <@r>bar<@end>\n" + "]\n" + ">>\n";
        writeFile(dir, "group.stg", groupFile);
    ...
    @Test
    public void testEmbeddedRegionTagsOnSeparateLines() throws Exception
    {
        String dir = getRandomDir();
        String groupFile = "a() ::= <<\n" + "[\n" + "  <@r>\n" + "  bar\n" + "  <@end>\n" + "]\n" + ">>\n";
        writeFile(dir, "group.stg", groupFile);
