...
{
    @Test
    public void testAbsoluteTemplateRefFromOutside() throws Exception
    {
    ...
    @Test
    public void testRelativeTemplateRefInExpr() throws Exception
    {
        // /randomdir/a and /randomdir/subdir/b
        String dir = getRandomDir();
        writeFile(dir, "a.st", "a(x) ::= << <subdir/b()> >>\n");
    ...
    @Test
    public void testAbsoluteTemplateRefInExpr() throws Exception
    {
        // /randomdir/a and /randomdir/subdir/b
        String dir = getRandomDir();
        writeFile(dir, "a.st", "a(x) ::= << </subdir/b()> >>\n");
    ...
    @Test
    public void testRefToAnotherTemplateInSameSubdir() throws Exception
    {
        // /randomdir/a and /randomdir/subdir/b
        String dir = getRandomDir();
        ...
        assertEquals(" bar ",
            group.getInstanceOf("/subdir/a")
                .render());
    }

    @Test
    public void testFullyQualifiedGetInstanceOf() throws Exception
    {
        String dir = getRandomDir();
    ...
    @Test
    public void testFullyQualifiedTemplateRef() throws Exception
    {
        // /randomdir/a and /randomdir/subdir/b
        String dir = getRandomDir();
    ...
    @Test
    public void testFullyQualifiedTemplateRef2() throws Exception
    {
    ...
    @Test
    public void testRelativeInSubdir() throws Exception
    {
        // /randomdir/a and /randomdir/subdir/b
        String dir = getRandomDir();
