...
{
    @Test
    public void testImportDir() throws Exception
    {
        /*
        dir1
    ...
    @Test
    public void testImportDirInJarViaCLASSPATH() throws Exception
    {
        /*
        sub
    ...
    @Test
    public void testImportGroupAtSameLevelInJar() throws Exception
    {
        /*
        org/foo/templates
        ...
        String main = "import \"lib.stg\"\n" + // should see in same dir as main.stg
            "a() ::= <<main a calls <bold()>!>>\n" + "b() ::= <<main b>>\n";
        writeFile(dir, "main.stg", main);

        String lib = "bold() ::= <<lib bold>>\n";
        writeFile(dir, "lib.stg", lib);

        writeTestFile("STGroup group = new STGroupFile(\"org/foo/templates/main.stg\");\n" +
            "group.setListener(listener);\n" +
    ...
    public void testImportGroupAtTopLevelInJar() throws Exception
    {
        ...
        writeTestFile("STGroup group = new STGroupFile(\"main.stg\");\n" +
            "group.setListener(listener);\n" +
            "ST st = group.getInstanceOf(\"a\");\n" +
            "String result = st!=null ? st.render() : null;\n", root);
        compile("Test.java", root);
    ...
    @Test
    public void testImportGroupAtSameLevelInJar2() throws Exception
    {
        /*
        org/foo/templates
            main.stg imports lib.stg
        ...
        writeTestFile("URL url = new STGroup().getURL(\"org/foo/templates/main.stg\");\n" +
    ...
    @Test
    public void testImportGroupInJarViaCLASSPATH() throws Exception
    {
        /*
        org/foo/templates
        ...
        System.out.println(root);
        String dir = root + "/org/foo/templates";
        String main = "import \"org/foo/lib/lib.stg\"\n" +
            "a() ::= <<main a calls <bold()>!>>\n" +
            "b() ::= <<main b>>\n";
        writeFile(dir, "main.stg", main);
    ...
    @Test
    public void testImportTemplateFileInJarViaCLASSPATH() throws Exception
    {
        /*
        org/foo/templates
    ...
    @Test
    public void testImportRelativeDir() throws Exception
    {
        /*
        dir
    ...
    @Test
    public void testImportRelativeDirInJarViaCLASSPATH() throws Exception
    {
        /*
        org/foo/templates
            g.stg has a() that imports subdir with relative path
    ...
    @Test
    public void testEmptyGroupImportGroupFileSameDir() throws Exception
    {
        /*
        dir
         ...
         */
        String dir = getRandomDir();
        String groupFile = "import \"group2.stg\"\n";
    ...
    @Test
    public void testImportGroupFileSameDir() throws Exception
    {
        /*
        dir
            group1.stg      that imports group2.stg in same dir with just filename
    ...
    @Test
    public void testImportRelativeGroupFile() throws Exception
    {
        /*
        dir
            group1.stg      that imports group2.stg in same dir with just filename
         ...
         */
        String dir = getRandomDir();
        String groupFile = "import \"subdir/group2.stg\"\n" + "a() ::= \"g1 a\"\n" + "b() ::= \"<c()>\"\n";
        writeFile(dir, "group1.stg", groupFile);
    ...
    @Test
    public void testImportTemplateFileSameDir() throws Exception
    {
        /*
        dir
    ...
    @Test
    public void testImportRelativeTemplateFile() throws Exception
    {
        /*
        dir
            group1.stg      that imports c.st
         ...
         */
        String dir = getRandomDir();
        String groupFile = "import \"subdir/c.st\"\n" + "a() ::= \"g1 a\"\n" + "b() ::= \"<c()>\"\n";
        writeFile(dir, "group1.stg", groupFile);
    ...
    @Test
    public void testImportTemplateFromAnotherGroupObject() throws Exception
    {
        /*
        dir1
            a.st
    ...
    @Test
    public void testImportTemplateInGroupFileFromDir() throws Exception
    {
        /*
        dir
            x
    ...
    @Test
    public void testImportTemplateInGroupFileFromGroupFile() throws Exception
    {
        String dir = getRandomDir();
        String groupFile = "a() ::= \"g1 a\"\n" + "b() ::= \"<c()>\"\n";
    ...
    @Test
    public void testImportTemplateFromSubdir() throws Exception
    {
    ...
    @Test
    public void testImportTemplateFromGroupFile() throws Exception
    {
        // /randomdir/x/subdir/a and /randomdir/y/subdir.stg which has a and b
        String dir = getRandomDir();
        writeFile(dir, "x/subdir/a.st", "a() ::= << </subdir/b()> >>");

        String groupFile = "a() ::= \"group file: a\"\n" + "b() ::= \"group file: b\"\n";
    ...
    @Test
    public void testPolymorphicTemplateReference() throws Exception
    {
        String dir1 = getRandomDir();
        String b = "b() ::= <<dir1 b>>\n";
        writeFile(dir1, "b.st", b);
    ...
    @Test
    public void testUnloadImportedTemplate() throws Exception
    {
        String dir1 = getRandomDir();
        String a = "a() ::= <<dir1 a>>\n";
        String b = "b() ::= <<dir1 b>>\n";
     ...
     */
    @Test
    public void testGroupFileInDirImportsAnotherGroupFile() throws Exception
    {
        // /randomdir/group.stg with a() imports /randomdir/imported.stg with b()
        // can't have groupdir then groupfile inside that imports
        String dir = getRandomDir();
        String groupFile = "import \"imported.stg\"\n" + "a() ::= \"a: <b()>\"\n";
        writeFile(dir, "group.stg", groupFile);
        String importedFile = "b() ::= \"b\"\n";
    ...
    @Test
    public void testGroupFileInDirImportsAGroupDir() throws Exception
    {
        /*
        dir
            g.stg has a() that imports subdir with relative path
    ...
    @Test
    public void testImportUtfTemplateFileSameDir() throws Exception
    {
        /*
        dir
