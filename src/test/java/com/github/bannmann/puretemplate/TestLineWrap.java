...
public class TestLineWrap extends BaseTest
{
    ...
    {
        String templates = "array(values) ::= <<{ <values; anchor, separator=\", \"> }>>" + newline;
        writeFile(tmpdir, "t.stg", templates);
        STGroup group = new STGroupFile(tmpdir + "/" + "t.stg");
    ...
    public void testFortranLineWrap() throws Exception
    {
        ...
        a.add("args", new String[]{ "a", "b", "c", "d", "e", "f" });
    ...
    @Test
    public void testLineWrapForList() throws Exception
    {
    ...
    public void testLineWrapForAnonTemplate() throws Exception
    {
        ...
        ST a = group.getInstanceOf("duh");
        a.add("data", new int[]{ 1, 2, 3, 4, 5, 6, 7, 8, 9 });
        String expecting = "![1][2][3]" + newline + // width=9 is the 3 char; don't break til after ]
            "[4][5][6]" + newline + "[7][8][9]!";
    ...
    public void testLineWrapForAnonTemplateAnchored() throws Exception
    {
        ...
        ST a = group.getInstanceOf("duh");
        a.add("data", new int[]{ 1, 2, 3, 4, 5, 6, 7, 8, 9 });
        String expecting = "![1][2][3]" + newline + " [4][5][6]" + newline + " [7][8][9]!";
        assertEquals(expecting, a.render(9));
    }
    ...
    public void testIndentBeyondLineWidth() throws Exception
    {
        ...
        a.add("chars", new String[]{ "a", "b", "c", "d", "e" });
        //
        String expecting = "    a" + newline + "    b" + newline + "    c" + newline + "    d" + newline + "    e";
    ...
    public void testIndentedExpr() throws Exception
    {
        ...
        a.add("chars", new String[]{ "a", "b", "c", "d", "e" });
        //
        String expecting = "    ab" + newline + "    cd" + newline + "    e";
    ...
    public void testNestedWithIndentAndTrackStartOfExpr() throws Exception
    {
        ...
        top.add("d", duh);
        //
        String expecting = "  x: ab" + newline + "     cd" + newline + "     e!";
