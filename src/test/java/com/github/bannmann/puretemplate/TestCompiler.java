...
public class TestCompiler extends BaseTest
{
    ...
    @Test
    public void testIncludeWithPassThrough() throws Exception
    {
        String template = "hi <foo(...)>";
        CompiledST code = new Compiler().compile(template);
    ...
    @Test
    public void testIncludeWithPartialPassThrough() throws Exception
    {
    ...
    @Test
    public void testSuperInclude() throws Exception
    {
    ...
    @Test
    public void testSuperIncludeWithArgs() throws Exception
    {
    ...
    @Test
    public void testSuperIncludeWithNamedArgs() throws Exception
    {
    ...
    @Test
    public void testIncludeWithArgs() throws Exception
    {
    ...
    @Test
    public void testAnonIncludeArgs() throws Exception
    {
    ...
    @Test
    public void testAnonIncludeArgMismatch() throws Exception
    {
    ...
    @Test
    public void testAnonIncludeArgMismatch2() throws Exception
    {
        STErrorListener errors = new ErrorBuffer();
    ...
    @Test
    public void testAnonIncludeArgMismatch3() throws Exception
    {
        STErrorListener errors = new ErrorBuffer();
    ...
    @Test
    public void testIndirectIncludeWitArgs() throws Exception
    {
        String template = "hi <(foo)(a,b)>";
        CompiledST code = new Compiler().compile(template);
    ...
    @Test
    public void testMapAsOption() throws Exception
    {
    ...
    @Test
    public void testIndirectMapArg() throws Exception
    {
    ...
    @Test
    public void testRepeatedMapArg() throws Exception
    {
    ...
    @Test
    public void testRotMap() throws Exception
    {
        String template = "<name:bold(),italics()>";
        CompiledST code = new Compiler().compile(template);
    ...
    @Test
    public void testRotMapArg() throws Exception
    {
    ...
    @Test
    public void testZipMapArg() throws Exception
    {
    ...
    @Test
    public void testAnonMap() throws Exception
    {
    ...
    @Test
    public void testAnonZipMap() throws Exception
    {
    ...
    @Test
    public void testOptionAsTemplate() throws Exception
    {
