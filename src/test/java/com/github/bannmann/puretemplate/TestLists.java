...
public class TestLists extends BaseTest
{
    ...
    {
        ST e = new ST("<[\"Ter\",,\"Jesse\"]:{n | <i>:<n>}; separator=\", \", null={foo}>");
        String expecting = "1:Ter, foo, 2:Jesse";
        assertEquals(expecting, e.render());
    }

    @Test
    public void testListLiteralWithEmptyFirstElement() throws Exception
    {
        ST e = new ST("<[,\"Ter\",\"Jesse\"]:{n | <i>:<n>}; separator=\", \", null={foo}>");
    ...
    {
        ST e = new ST("<length([names,phones])>");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[names,phones]; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[names,phones,salaries]; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[names:{n|<n>!},phones]; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[{<if(names)>doh<endif>},phones]; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    @Test
    public void testCatNullValues() throws Exception
    {
        // [a, b] must behave like <a><b>; if a==b==null, blank output
        // unless null argument.
        ST e = new ST("<[no,go]; null=\"foo\", separator=\", \">");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[names:{n|<n>!},\"foo\"]:{a|x}; separator=\", \">");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    {
        ST e = new ST("<[names, [\"foo\",\"bar\"]:{x | <x>!},phones]; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        e.add("phones", "1");
        e.add("phones", "2");
    ...
    @Test
    public void testListWithTwoEmptyListsCollapsesToEmptyList() throws Exception
    {
        ST e = new ST("<[[],[]]:{x | <x>!}; separator=\", \">");
        e.add("names", "Ter");
        e.add("names", "Tom");
        String expecting = "";
        assertEquals(expecting, e.render());
