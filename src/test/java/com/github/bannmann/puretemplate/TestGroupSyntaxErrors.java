...
{
    @Test
    public void testMissingImportString() throws Exception
    {
        ...
        String expected = "t.stg 2:0: mismatched input 'foo' expecting STRING" +
            newline +
            "t.stg 2:3: missing EOF at '('" +
            newline;
    ...
    @Test
    public void testImportNotString() throws Exception
    {
    ...
    @Test
    public void testUnclosedTemplate() throws Exception
    {
        String templates = "foo() ::= {";
        writeFile(tmpdir, "t.stg", templates);
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "t.stg 1:11: missing final '}' in {...} anonymous template" +
            newline +
    ...
    @Test
    public void testArg3() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "[t.stg 1:6: no viable alternative at input 'b']";
        String result = errors.errors.toString();
        assertEquals(expected, result);
    }

    @Test
    public void testDefaultArgsOutOfOrder() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "[t.stg 1:12: required parameters (b) must appear before optional parameters]";
        String result = errors.errors.toString();
        assertEquals(expected, result);
    }

    @Test
    public void testArgumentRedefinition() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "[t.stg 1:8: redefinition of parameter a]";
        String result = errors.errors.toString();
        assertEquals(expected, result);
    }

    @Test
    public void testArgumentRedefinitionInSubtemplate() throws Exception
    {
        ...
        group.setListener(errors);
        group.load(); // force load
        String expected = "[t.stg 1:43: redefinition of parameter a, " +
    ...
    @Test
    public void testErrorWithinTemplate() throws Exception
    {
