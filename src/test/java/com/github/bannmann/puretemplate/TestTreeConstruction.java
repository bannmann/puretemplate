...
public class TestTreeConstruction extends gUnitBase
{
    ...
    public void setup()
    {
        lexerClassName = "com.github.bannmann.puretemplate.compiler.STLexer";
        parserClassName = "com.github.bannmann.puretemplate.compiler.STParser";
    }

    @Test
    public void test_template1() throws Exception
    {
    ...
    @Test
    public void test_template2() throws Exception
    {
