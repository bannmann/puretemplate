...
public class STViz
{
        ...
        viewFrame.ast.addTreeSelectionListener(new TreeSelectionListener()
        {
            ...
            public void valueChanged(TreeSelectionEvent treeSelectionEvent)
            {
                ...
                try
                {
                    ...
                    CommonTree node = (CommonTree) treeSelectionEvent.getNewLeadSelectionPath()
    ...
    protected void setText(JEditorPane component, String text)
    {
        ...
        component.getDocument()
            .putProperty(WINDOWS_LINE_ENDINGS, windowsLineEndings);
    }

    protected int toComponentPosition(JTextComponent component, int position)
    {
        int[] windowsLineEndings = (int[]) component.getDocument()
            .getProperty(WINDOWS_LINE_ENDINGS);
